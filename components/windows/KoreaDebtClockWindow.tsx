...
export default function KoreaDebtClockWindow() {
  const data = project.KOREA_DEBT_CLOCK;
      ...
      <div className="flex-1 overflow-y-auto bg-white win95-sunken">
        ...
        <div className="bg-blue-900 text-white px-4 py-3 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-system-caption opacity-75">{data.period} · 국가부채 실시간 대시보드</p>
          </div>
        </div>
